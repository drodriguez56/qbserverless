...
exports.user = exports.createCompany = exports.apiCall = exports.connected = exports.qbCallback = exports.qbAuthUrl = undefined;
...
var _Company = __webpack_require__(18);
...
var createCompany = exports.createCompany = function createCompany(event, context, callback) {
  ...
  db.once("open", function () {
    company.save().then(function () {
      callback(null, {
        statusCode: 200,
        body: (0, _stringify2.default)({ id: company[mongooseId] })
      });
    }).catch(function (err) {
      callback(null, createErrorResponse(err.statusCode, err.message));
    }).finally(function () {
